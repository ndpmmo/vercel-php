        ...
        <div class="row">
          <div class="col-md-12">
            <div class="footer-info padding">
              <h3>联系方式</h3>
              <p><i class="fa fa-map-marker" aria-hidden="true"></i>3128 Helen Path
Noehaven, GA 23262</p>
              <p><i class="fa fa-paper-plane" aria-hidden="true"></i>gbotsford@hotmail.com</p>
              <p><i class="fa fa-phone" aria-hidden="true"></i>+2105753032206</p>
            </div>
          </div>
        </div>
      </div>
